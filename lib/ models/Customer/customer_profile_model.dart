...
class CustomerModel {
   ...
   DateTime createdAt; // The date and time the customer was created in your system
   DateTime updatedAt; // The date and time the customer was last updated in your system
